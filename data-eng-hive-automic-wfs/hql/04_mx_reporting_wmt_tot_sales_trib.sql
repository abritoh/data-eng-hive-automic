...
dfs -chgrp -R ${group_name} /user/hive/warehouse/${target_schema}.db/${target_table_sales_trib}; 
dfs -chmod -R ${permission} /user/hive/warehouse/${target_schema}.db/${target_table_sales_trib};
